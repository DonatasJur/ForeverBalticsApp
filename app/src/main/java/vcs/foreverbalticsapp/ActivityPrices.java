...
public class ActivityPrices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView wv = (WebView) findViewById(R.id.webview4);

        // add your link here
        wv.loadUrl("https://foreverliving.box.com/s/wooqcnocf91nzzgejhgkqtc2mq46mewp");
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String s1, String s2, String s3, long l) {
                ...
                dm.enqueue(req);
                Toast.makeText(ActivityPrices.this, "Downloading....", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ActivityPrices.this).create();
