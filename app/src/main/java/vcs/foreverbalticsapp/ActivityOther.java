...
public class ActivityOther extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView wv = (WebView) findViewById(R.id.webview5);

        // add your link here
        wv.loadUrl("https://foreverliving.box.com/s/o62haxgke0c0zm5x9baalwpzx1866kpv");
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String s1, String s2, String s3, long l) {
                ...
                dm.enqueue(req);
                Toast.makeText(ActivityOther.this, "Downloading....", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ActivityOther.this).create();
