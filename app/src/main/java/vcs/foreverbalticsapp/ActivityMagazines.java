...
public class ActivityMagazines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String s1, String s2, String s3, long l) {
                ...
                dm.enqueue(req);
                Toast.makeText(ActivityMagazines.this, "Downloading....", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ActivityMagazines.this).create();
